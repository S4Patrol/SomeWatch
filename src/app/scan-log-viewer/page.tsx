    ...
    if (isLoading) {
        return (
            <div className="flex items-center justify-center min-h-screen text-[--muted]">
                <p>Kaydedilmiş loglar yükleniyor...</p>
            </div>
        )
    }
            ...
            {isDragging && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-gray-950/80 backdrop-blur-sm">
                    <div className="flex flex-col items-center gap-3 p-8 border-2 border-dashed border-indigo-500 rounded-xl bg-gray-900/50">
                        ...
                        <p className="text-lg font-medium text-indigo-300">Log dosyasını buraya sürükle</p>
                    </div>
                </div>
            )}
            ...
            <div className="mb-4">
                <div className="flex items-center gap-4 justify-between">
                    <div className="flex items-center gap-4">
                        <h1 className="text-xl font-bold text-gray-200 tracking-tight">Tarama log analyzer</h1>
                        <label
                        ...
                        >
                            <BiUpload />
                            <span>{content ? "Başka bir dosya yükle" : "Tarama log dosyasını yükle"}</span>
                            <input
                                type="file"
                                ref={fileInputRef}
