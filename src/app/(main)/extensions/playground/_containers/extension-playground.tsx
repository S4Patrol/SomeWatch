            ...
            <div className="w-full">
                ...
                <div className="flex items-center w-full">
                    <div className="w-full flex items-center gap-4">
                        <h2 className="w-fit">Oyun alanı</h2>
                                                ...
                                                {type === "manga-provider" && (
                                                    <>
                                                        ...
                                                        {selectedFunction === Functions.MangaProviderSearch && (
                                                            <>
                                                                <Alert intent="info">
                                                                    SomeWatch, manga başlıklarına göre en iyi eşleşmeyi otomatik olarak seçecektir.
                                                                </Alert>
                                                            </>
                                                        )}
                                                        ...
                                                        {selectedFunction === Functions.OnlinestreamSearch && (
                                                            <>
                                                                <Alert intent="info" className="text-sm">
                                                                    SomeWatch, anime başlıklarına göre en iyi eşleşmeyi otomatik olarak seçecektir.
                                                                </Alert>
                                        ...
                                        <ResizablePanel defaultSize={70}>
                                            <div className="h-full w-full p-2">
                                                <div className="flex items-center gap-2 justify-between mb-2">
                                                    <p className="font-semibold">Çıktı</p>
                                                    <IconButton
