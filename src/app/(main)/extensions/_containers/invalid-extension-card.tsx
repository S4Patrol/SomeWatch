    ...
    return (
        ...
        >
            ...
            <div className="absolute top-3 right-3 grid grid-cols-2 gap-1 p-1 rounded-[--radius-md] bg-gray-900 z-[2]">
                ...
                >
                    <p>
                        SomeWatch bu eklentiyi yükleyemedi. Ne anlama geldiğinden emin değilseniz, lütfen geliştiriciyle iletişime geçin.
                    </p>
                    <p>
                        Kod: <strong>{extension.code}</strong>
                    </p>
    ...
    return (
        ...
        >
            ...
            <div className="absolute top-3 right-3 flex flex-col gap-1 p-1 rounded-xl bg-gray-900 z-[2]">
                ...
                >
                    <p>
                        Eklenti <span className="font-bold">{extension.extension?.name}</span> şu izinleri talep ediyor:
                    </p>
