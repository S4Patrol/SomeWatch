...
import { TbReload, TbSubtask } from "react-icons/tb"
...
export const EXTENSION_TYPE = {
    "plugin": "Eklenti",
    "anime-torrent-provider": "Anime Torrent Sağlayıcısı",
    "manga-provider": "Manga Sağlayıcısı",
    "onlinestream-provider": "Çevrimiçi Yayın Sağlayıcısı",
...
export function ExtensionList(props: ExtensionListProps) {
    ...
    const fansubExtensions = orderExtensions(allExtensions?.extensions ?? []).filter(n => n.type === "fansub")
        ...
        <AppLayoutStack className="gap-6">
            <div className="flex items-center gap-2 flex-wrap">
                <div>
                    ...
                    <p className="text-[--muted] text-sm">
                        Eklentilerinizi ve içerik sağlayıcılarınızı yönetin.
                    </p>
                </div>
            ...
            {!!pluginPermissionsNotGrantedExtensions?.length && (
                <Card className="p-4 space-y-6">
                    <h3 className="flex gap-3 items-center">Yetkilendirme gerekli</h3>
            ...
            {!!nonvalidExtensions?.length && (
                <Card className="p-4 space-y-6 border-red-800">
                    ...
                    <h3 className="flex gap-3 items-center">Geçersiz eklenti</h3>
                ...
                <Card className="p-4 space-y-6">
                    <div>
                        ...
                        <p className="text-[--muted] text-sm mt-1">
                            Kalıcı fansub eklentileri. Bu eklentiler kaldırılamaz.
                        </p>
                    </div>
                    <div className="grid grid-cols-1 lg:grid-cols-3 2xl:grid-cols-4 gap-4">
