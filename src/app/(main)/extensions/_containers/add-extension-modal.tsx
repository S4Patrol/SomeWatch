            ...
            >
                <div className="flex gap-4 flex-col lg:flex-row">
                    <div className="lg:w-1/3">
                        <h3 className="text-2xl font-bold">URL'sini indir</h3>
                        <p className="text-[--muted]">Manifest URL’sini girerek bir eklenti yükleyin.</p>
                    </div>
                ...
                {!extensionData && (
                    <>
                        ...
                        <p className="text-center text-[--muted]">
                            Ayrıca bir depodan içe aktararak birden fazla eklentiyi aynı anda yükleyebilirsiniz.
                           </p>

                                 <div className="flex gap-4 flex-col lg:flex-row-reverse">
                             <div className="lg:w-1/3">
                               <h3 className="text-xl font-bold">Depodan içe aktar</h3>
                                       <p className="text-[--muted]">Bir depo URL’si girerek eklentileri içe aktarın ve otomatik olarak yükleyin.</p>
                            </div>
                            <div className="lg:w-2/3 gap-3 flex flex-col">
                                <TextInput
