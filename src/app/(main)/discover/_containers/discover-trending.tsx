...
import { useSupabaseDiscoverTrendingAnime, __discover_supabase_trendingGenresAtom } from "@/app/(main)/discover/_lib/handle-supabase-discover-queries"
...
export function DiscoverTrending() {
    ...
    const { data, isLoading } = useSupabaseDiscoverTrendingAnime()
...
function GenreSelector(props: GenreSelectorProps) {
    ...
    const [selectedGenre, setSelectedGenre] = useAtom(__discover_supabase_trendingGenresAtom)
