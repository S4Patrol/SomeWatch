        ...
        <>
            <div data-anime-entry-card-next-airing-container className="flex gap-1 items-center justify-center">
                ...
                <p data-anime-entry-card-next-airing className="text-justify font-normal text-xs min-[2000px]:text-md">
                    <span className="font-semibold">{nextAiring?.episode}</span>. Bölüm {formatDistanceToNow(addSeconds(new Date(),
        ...
        <>
            ...
            >
                ...
                >
                    ...
                    {/* 4K BADGE */}
                    {is_4k && (
                        <div className="absolute z-[10] left-1 top-2">
                            <div className="bg-gradient-to-br from-cyan-400 via-teal-500 to-emerald-600 text-white text-[10px] font-black px-1.5 py-0.5 rounded shadow-[0_0_10px_rgba(20,184,166,0.4)] border border-white/20 tracking-tighter">
                                4K
                            </div>
                        </div>
                    )}
        ...
        >
            ...
            {(status === "RELEASING" || status === "NOT_YET_RELEASED") &&
                <div data-media-entry-card-hover-popup-banner-releasing-badge-container className="absolute z-[10] right-1 top-2">
                    ...
                    >
                        {status === "RELEASING" ? "Yayınlanıyor" : "Henüz yayınlanmadı"}
                    </Tooltip>
                </div>}
