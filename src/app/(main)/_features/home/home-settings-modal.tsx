...
const HOME_ITEM_ICONS = {
    ...
    "my-lists": LuListTodo,
    "sitemizdekiler": IoLibraryOutline,
} as const
...
export function HomeSettingsModal({ emptyLibrary, isNakamaLibrary }: { emptyLibrary?: boolean, isNakamaLibrary: boolean }) {
    ...
    const handleUpdateItemOptions = (id: string, options: any) => {
        ...
        updateHomeItems({ items: newItems }, {
            onSuccess: () => {
                toast.success("Ana sayfa düzeni güncellendi")
                ...
                <div className="space-y-6">
                    ...
                    >
                        <div className="flex items-center gap-2 mb-4">
                            ...
                            <h4 className="text-lg font-semibold">Ana Sayfa Düzeni</h4>
                        </div>
                                    ...
                                    <div className="space-y-2 bg-gray-900/30 rounded-xl p-4 border border-gray-800">
                                        {currentItems.length === 0 ? (
                                            <div className="text-center py-8 text-gray-400">
                                                Henüz öğe eklenmedi. Ana sayfanızı özelleştirmek için aşağıdan öğe ekleyin.
                                            </div>
                                        ) : (
                    ...
                    >
                        <div className="flex items-center gap-2 mb-4">
                            ...
                            <h4 className="text-lg font-semibold">Kullanılabilir Öğeler</h4>
                        </div>

                        {availableItems.length === 0 ? (
                            <div className="text-center py-6 text-gray-400">
                                Tüm kullanılabilir öğeler ana sayfanıza eklendi.
                            </div>
                        ) : (
...
function HomeItemOptionsModal({ id, item, isOpen, onClose, onSave, isUpdating }: HomeItemOptionsModalProps) {
    ...
    return (
        <Modal
            ...
            title={
                <div className="flex items-center gap-2">
                    ...
                    {homeItemConfig.name} Yapılandır
                </div>
            }
        ...
        >
            <div className="space-y-6">
                <div className="text-sm text-gray-400">
                    Bu ana sayfa öğesi için ayarları özelleştirin.
                </div>
