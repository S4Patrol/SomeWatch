            ...
            <div className={cn("flex flex-wrap w-full justify-end gap-1 p-4 relative z-[10]", className)} data-home-toolbar-container>
                    ...
                    <SeaLink href="/extensions?tab=marketplace&type=anime-torrent-provider">
                        <span>
                            <Tooltip
                                ...
                                >
                                    Eksik eklentileri ekle
                                </Button>}
                            >
                                Torrent sağlayıcı yüklü değil.
                            </Tooltip>
                        </span>
                    </SeaLink>}
                {(hasEntries) && (
                    <>
                        {(!isStreamingOnly && !isNakamaLibrary) && <Tooltip
                            ...
                            />}
                        >
                            {homeView === "base" ? "Yerel Anime Kütüphanesi" : "Ana Sayfa"}
                        </Tooltip>}
                ...
                {!isNakamaLibrary && hasLibraryPath && <Tooltip
                    trigger={<div>
                        ...
                        >
                            {hasEntries ? "Yenile" : "Tara"}
                        </Button>
                    </div>}
                >
                    {hasEntries ? "Anime Kütüphanesini Yenile" : "Anime Kütüphanesini Tara"}
                </Tooltip>}
                ...
                >
                    Eşleşmeyenleri çöz ({unmatchedLocalFiles.length})
                </Button>}
                ...
                >
                    Gizli medyaları çöz ({unknownGroups.length})
                </Button>}
