...
export function VideoCoreSubtitleMenu({ inline }: { 
    inline?: boolean
}) {
    ...
    return (
        <VideoCoreMenu
            ...
            />}
        >
            <VideoCoreMenuTitle>{t.subtitles} {(!!subtitleManager && !inline) && <Tooltip
            ...
            <VideoCoreMenuBody>
                <VideoCoreSettingSelect
                    ...
                    onValueChange={(value: number | string) => {
                        ...
                        if (subtitleManager) {
                            subtitleManager.selectTrack(value as number)
                        } else if (mediaCaptionsManager) {
                            mediaCaptionsManager.selectTrack(value as number)
                            setSelectedTrack(value as number)
                        }
                    }}
