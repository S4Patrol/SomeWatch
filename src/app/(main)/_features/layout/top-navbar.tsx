...
import { LuFolderDown, LuSearch } from "react-icons/lu"
import { useSeaCommand } from "../sea-command/sea-command"
            ...
            >
                ...
                >
                    <div data-top-navbar-content className="flex items-center w-full gap-3 z-[90]" style={{ WebkitAppRegion: "no-drag" } as any}>
                        ...
                        {/* Search Bar */}
                        <div
                            className="relative hidden md:flex items-center max-w-sm w-full ml-2 cursor-pointer group"
                            onClick={() => {
                                setSeaCommandInput("")
                        ...
                        >
                            <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                <LuSearch className="text-gray-400 group-hover:text-brand-300 text-lg transition-colors" />
                            </div>
                            <div
                                className={cn(
                                    "block w-full pl-10 pr-12 py-2 border border-white/5 rounded-full leading-5",
                                    "bg-white/5 group-hover:bg-white/10 text-gray-400 group-hover:text-gray-200",
                            ...
                            <div className="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                                <span className="text-[10px] font-medium text-gray-500 bg-white/5 border border-white/10 px-1.5 py-0.5 rounded-md">
                                    CTRL K
                                </span>
                            </div>
                        </div>
