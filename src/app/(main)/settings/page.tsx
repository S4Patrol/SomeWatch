                            ...
                            <div className="overflow-x-none overflow-y-hidden rounded-[--radius-md] space-y-1 lg:space-y-3 flex justify-center flex-wrap lg:block">
                                ...
                                <Card className="lg:p-2 contents lg:block border-0 bg-transparent lg:border lg:bg-gray-950/80">
                                    <div className="space-y-2 p-4 w-full">
                                        <h4 className="text-center text-xl font-bold">Ayarlar</h4>
                                ...
                                <Card className="lg:p-2 contents lg:block border-0 bg-transparent lg:border lg:bg-gray-950/80">
                                    <TabsTrigger
                                        value="seanime"
                                        className="group"
                                    ><LuWandSparkles className="text-xl mr-3 transition-transform duration-200" /> Uygulama</TabsTrigger>
                                    {/* <TabsTrigger
                                     value="local"
                                     className="group"
                                    ...
                                    <TabsTrigger
                                        value="library"
                                        className="group"
                                    ><LuLibrary className="text-xl mr-3 transition-transform duration-200" /> Yerel Anime Kütüphanesi</TabsTrigger>
                                    <TabsTrigger
                                        value="playback"
                                        className="group"
                                    ><LuCirclePlay className="text-xl mr-3 transition-transform duration-200" /> Video Oynatma</TabsTrigger>
                                </Card>

                                {/*<div className="text-xs lg:text-[--muted] text-center py-1.5 uppercase px-3 border-gray-800 tracking-wide font-medium">*/}
                                {/*    Anime playback*/}
                                {/*</div>*/}                                <Card className="lg:p-2 contents lg:block border-0 bg-transparent lg:border lg:bg-gray-950/80">
                                    <TabsTrigger
                                        value="media-player"
                                        className="group"
                                    ><LuMonitorPlay className="text-xl mr-3 transition-transform duration-200" /> Masaüstü Medya Oynatıcı</TabsTrigger>
                                    <TabsTrigger
                                        value="external-player-link"
                                        className="group"
                                    ><LuCircleArrowOutUpRight className="text-xl mr-3 transition-transform duration-200" /> Harici Oynatıcı
                                                                                                                             Bağlantısı</TabsTrigger>
                                    <TabsTrigger
                                        value="mediastream"
                                        className="relative group"
                                    ><LuTabletSmartphone className="text-xl mr-3 transition-transform duration-200" /> Transcoding / Doğrudan
                                                                                                                       Oynatma</TabsTrigger>
                                </Card>
                                ...
                                <Card className="lg:p-2 contents lg:block border-0 bg-transparent lg:border lg:bg-gray-950/80">
                                    <TabsTrigger
                                        value="torrent"
                                        className="group"
                                    ><LuFileSearch className="text-xl mr-3 transition-transform duration-200" /> Torrent Sağlayıcı</TabsTrigger>
                                    <TabsTrigger
                                        value="torrent-client"
                                        className="group"
                                    ><MdOutlineDownloading className="text-xl mr-3 transition-transform duration-200" /> Torrent İstemcisi</TabsTrigger>
                                    <TabsTrigger
                                        value="torrentstream"
                                        className="relative group"
                                    ><SiBittorrent className="text-xl mr-3 transition-transform duration-200" /> Torrent Akışı</TabsTrigger>
                                    <TabsTrigger
                                        value="debrid"
                                        className="group"
                                    ><HiOutlineServerStack className="text-xl mr-3 transition-transform duration-200" /> Debrid Hizmeti</TabsTrigger>
                                </Card>
                                ...
                                <Card className="lg:p-2 contents lg:block border-0 bg-transparent lg:border lg:bg-gray-950/80">
                                    <TabsTrigger
                                        value="onlinestream"
                                        className="group"
                                    ><CgMediaPodcast className="text-xl mr-3 transition-transform duration-200" /> Çevrimiçi Akış (Online)</TabsTrigger>
                                ...
                                <Card className="lg:p-2 contents lg:block border-0 bg-transparent lg:border lg:bg-gray-950/80">
                                    ...
                                    <TabsTrigger
                                        value="ui"
                                        className="group"
                                    ><MdOutlinePalette className="text-xl mr-3 transition-transform duration-200" /> Kullanıcı Arayüzü</TabsTrigger>
                                    {/* <TabsTrigger
                                     value="cache"
                                     className="group"
                                    ...
                                    <TabsTrigger
                                        value="logs"
                                        className="group"
                                    ><LuBookKey className="text-xl mr-3 transition-transform duration-200" /> Kayıtlar & Önbellek</TabsTrigger>
                                </Card>
                            </div>
                        </SettingsNavCard>
                    ...
                    <div className="">
                            ...
                            {(f) => {
                                return <>
                                                    ...
                                                    checkForUpdates(undefined, {
                                                        onSuccess: (data) => {
                                                            if (data?.release) {
                                                                ...
                                                                toast.success("En son sürümü kullanıyorsunuz")
                                                            }
                                    ...
                                    <TabsContent value="library" className={tabContentClass}>
                                        ...
                                        <SettingsPageHeader
                                            title="Yerel Anime Kütüphanesi"
                                            description="Yerel anime kütüphanenizi yönetin"
                                            icon={LuLibrary}
                                        />
                                    ...
                                    <TabsContent value="onlinestream" className={tabContentClass}>
                                        ...
                                        <SettingsPageHeader
                                            title="Çevrimiçi Akış (Online)"
                                            description="Çevrimiçi akış ayarlarını yapılandırın"
                                            icon={CgMediaPodcast}
                                        />
                                        ...
                                        <SettingsCard>
                                            <Field.Switch
                                                ...
                                                label="Etkinleştir"
                                                help="Anime bölümlerini çevrimiçi kaynaklardan izleyin."
                                            />
                                        </SettingsCard>

                                        <SettingsCard title="Ana Ekran">
                                            <Field.Switch
                                                side="right"
                                                name="includeOnlineStreamingInLibrary"
                                                label="Anime kütüphanesine dâhil et"
                                                help="İndirilmeyen ancak mevcut izleme listenizde olan dizileri anime kütüphanesine ekleyin."
                                            />
                                        </SettingsCard>
                                    ...
                                    <TabsContent value="discord" className={tabContentClass}>
                                        ...
                                        <SettingsPageHeader
                                            title="Discord"
                                            description="Discord zengin varlık (Rich Presence) ayarlarını yapılandırın"
                                            icon={FaDiscord}
                                        />
                                    ...
                                    <TabsContent value="torrent" className={tabContentClass}>
                                        ...
                                        <SettingsPageHeader
                                            title="Torrent Sağlayıcı"
                                            description="Torrent sağlayıcısını yapılandırın"
                                            icon={LuFileSearch}
                                        />
                                        ...
                                        <SettingsCard>
                                            <Field.Select
                                                ...
                                                help="Arama motoru tarafından kullanılır. Torrent desteğine ihtiyacınız yoksa 'Hiçbiri' seçeneğini belirleyin."
                                                ...
                                                options={[
                                                    ...
                                                    { label: "Hiçbiri", value: TORRENT_PROVIDER.NONE },
                                                ]}
                                            />
                                        </SettingsCard>
                                    ...
                                    <TabsContent value="torrent-client" className={tabContentClass}>
                                        ...
                                        <SettingsPageHeader
                                            title="Torrent İstemcisi"
                                            description="Torrent istemcisini yapılandırın"
                                        ...
                                        <SettingsCard>
                                            <Field.Select
                                                ...
                                                label="Varsayılan Torrent İstemcisi"
                                                options={[
                                            ...
                                            <AccordionItem value="qbittorrent">
                                                ...
                                                <AccordionContent className="p-0 py-4 space-y-4">
                                                    ...
                                                    <Field.Text
                                                        ...
                                                        label="Çalıştırılabilir Dosya (Executable)"
                                                    />
                                                    <Field.Text
                                                        name="qbittorrentTags"
                                                        label="Etiketler"
                                                        help="İndirilen torrentlere uygulanacak virgülle ayrılmış etiketler. örn. seanime,anime"
                                                    />
                                                    <Field.Text
                                                        name="qbittorrentCategory"
                                                        label="Kategori"
                                                        help="İndirilen torrentlere uygulanacak kategori."
                                                    />
                                                </AccordionContent>
                                            </AccordionItem>
                                        ...
                                        <SettingsCard title="Entegrasyon">
                                            {/*<Field.Switch*/}
                                            {/*    side="right"*/}
                                            ...
                                            <Field.Switch
                                                ...
                                                label="Aktif torrent sayısını göster"
                                                help="Kenar çubuğunda aktif torrent sayısını göster. (Bellek yoğun)"
                                            />
                                            <Field.Switch
                                                side="right"
                                                name="openTorrentClientOnStart"
                                                label="Başlangıçta torrent istemcisini aç"
                                            />
                                        </SettingsCard>
                        ...
                        <TabsContent value="ui" className={tabContentClass}>
                            ...
                            <SettingsPageHeader
                                ...
                                description="Kullanıcı arayüzünü özelleştirin"
                                icon={LuPalette}
                            />
                        ...
                        <TabsContent value="torrentstream" className={tabContentClass}>
                            ...
                            <SettingsPageHeader
                                title="Torrent Akışı"
                                description="Torrent akışı ayarlarını yapılandırın"
                                icon={SiBittorrent}
                            />
                        ...
                        <TabsContent value="logs" className={tabContentClass}>
                            ...
                            <SettingsPageHeader
                                title="Kayıtlar"
                                description="Kayıtları görüntüleyin"
                                icon={LuBookKey}
                            />
                        ...
                        {__isElectronDesktop__ && (
                            <TabsContent value="denshi" className={tabContentClass}>
                                ...
                                <SettingsPageHeader
                                    title="Denshi"
                                    description="Masaüstü istemcisi ayarları"
                                    icon={LuMonitor}
                                />
