    ...
    return (
        <>
                ...
                <Alert
                    ...
                    description={
                        <div className="flex items-center justify-between gap-3">
                            <span>Harici oynatıcı için özel bir düzen ayarlanmamış</span>
                            <Button
                                intent="gray-outline"
                                size="sm"
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div className="flex-1">
                                <Switch
                                    label="SomeWatch Denshi"
                                    help="Etkinleştirildiğinde, tüm medya oynatma, yerleşik oynatıcıyı kullanacaktır (aşağıdaki ayarları geçersiz kılar)"
                                    ...
                                    onValueChange={v => {
                                        ...
                                        toast.success("SomeWatch Denshi başarıyla etkinleştirildi!")
                                    }}
                                />
                            </div>
                        </div>
            ...
            <SettingsCard
                ...
                description="Cihazınızda depolanan medya dosyalarını nasıl oynatacağınızı seçin"
                className={cn(
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div
                            ...
                            onClick={() => {
                                ...
                                toast.success("Oynatma ayarları güncellendi")
                            }}
                        >
                            <div className="flex items-start gap-3">
                                ...
                                <div className="flex-1 space-y-2">
                                    <div>
                                        <p className="font-medium">Web Player</p>
                                        <p className="text-xs text-gray-600 dark:text-gray-400">İndirilen medyayı tarayıcınızda oynatır</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        >
                            <div className="flex items-start gap-3">
                                ...
                                <div className="flex-1 space-y-2">
                                    <div>
                                        <p className="font-medium">Transcoding / Doğrudan Oynatma</p>
                                        <p className="text-xs text-gray-600 dark:text-gray-400">
                                            {serverStatus?.mediastreamSettings?.transcodeEnabled
                                                ? "Tarayıcıda Transcoding ile oynatılır"
                                                : "Dönüştürme etkin değil"
                                            }
                                        </p>
                                    </div>
                                </div>
                        ...
                        >
                            <div className="flex items-start gap-3">
                                ...
                                <div className="flex-1 space-y-2">
                                    <div>
                                        <p className="font-medium">Harici Oynatıcı Bağlantısı</p>
                                        <p className="text-xs text-gray-600 dark:text-gray-400">Stream URL'sini başka bir uygulamaya gönderir</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <SettingsCard
                ...
                description="Torrent ve debrid servislerinden akış içeriğini nasıl oynatacağınızı seçin"
                className={cn(
                    "transition-all duration-200",
                    usingNativePlayer && "opacity-50",
                )}
                ...
                <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div
                            className={cn(
                                "p-4 rounded-lg border cursor-pointer transition-all",
                                torrentStreamingPlayback === PlaybackTorrentStreaming.WebPlayer
                                    ? "border-[--brand] bg-brand-900/10"
                                    : "border-gray-700 hover:border-gray-600",
                            )}
                            onClick={() => {
                                setTorrentStreamingPlayback(PlaybackTorrentStreaming.WebPlayer)
                                toast.success("Oynatma ayarları güncellendi - Torrent'ler artık tarayıcıda oynatılacak")
                            }}
                        >
                            <div className="flex items-start gap-3">
                                <MdOutlineBroadcastOnHome className="text-xl text-brand-600 dark:text-brand-400 mt-1" />
                                <div className="flex-1 space-y-2">
                                    <div>
                                        <p className="font-medium">Web Player (Denshi)</p>
                                        <p className="text-xs text-gray-600 dark:text-gray-400">Torrent'leri doğrudan tarayıcıda oynatır - MPV/VLC gerekmez</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        >
                            <div className="flex items-start gap-3">
                                ...
                                <div className="flex-1 space-y-2">
                                    <div>
                                        <p className="font-medium">Masaüstü Medya Oynatıcı</p>
                                        <p className="text-xs text-gray-600 dark:text-gray-400">Akışları sistem oynatıcınızda otomatik izleme ile açar</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        >
                            <div className="flex items-start gap-3">
                                ...
                                <div className="flex-1 space-y-2">
                                    <div>
                                        <p className="font-medium">Harici Oynatıcı Bağlantısı</p>
                                        <p className="text-xs text-gray-600 dark:text-gray-400">Akış URL'sini başka bir uygulamaya gönderir</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div className="flex items-center gap-2 text-sm text-gray-500 bg-gray-50 dark:bg-gray-900/30 rounded-lg p-3 border border-gray-200 dark:border-gray-800 border-dashed">
                ...
                <span>Ayarlar otomatik kaydedilir</span>
            </div>
