                ...
                {hasProfile && (
                    <div className="text-sm text-[--muted] space-y-1">
                        {profile.resolutions && profile.resolutions.length > 0 && (
                            <p><strong>Çözünürlükler:</strong> {profile.resolutions.join(", ")}</p>
                        )}
                        {profile.releaseGroups && profile.releaseGroups.length > 0 && (
                            <p><strong>Gruplar:</strong> {profile.releaseGroups.slice(0, 3).join(", ")}{profile.releaseGroups.length > 3 ? "..." : ""}
                            </p>
                        )}
                        {profile.providers && profile.providers.length > 0 && (
                            <p><strong>Sağlayıcılar:</strong> {profile.providers.join(", ")}</p>
                        )}
                        {profile.preferredCodecs && profile.preferredCodecs.length > 0 && (
                            <p><strong>Tercih Edilen Codec'ler:</strong> {profile.preferredCodecs.join(", ")}</p>
                        )}
                        {profile.preferredSources && profile.preferredSources.length > 0 && (
                            <p><strong>Tercih Edilen Kaynaklar:</strong> {profile.preferredSources.join(", ")}</p>
                        )}
                        {profile.preferredLanguages && profile.preferredLanguages.length > 0 && (
                            <p><strong>Tercih Edilen Diller:</strong> {profile.preferredLanguages.join(", ")}</p>
                        )}
                        {profile.multipleAudioPreference && profile.multipleAudioPreference !== "neutral" && (
                            <p><strong>Çoklu Ses Tercihi:</strong> {capitalize(profile.multipleAudioPreference)}</p>
                        )}
                        {profile.multipleSubsPreference && profile.multipleSubsPreference !== "neutral" && (
                            <p><strong>Çoklu Altyazı Tercihi:</strong> {capitalize(profile.multipleSubsPreference)}</p>
                        )}
                        {profile.bestReleasePreference && profile.bestReleasePreference !== "neutral" && (
                            <p><strong>En İyi Sürümler:</strong> {capitalize(profile.bestReleasePreference)}</p>
                        )}
                        {profile.batchPreference && profile.batchPreference !== "neutral" && (
                            <p><strong>Toplu İndirme Tercihi:</strong> {capitalize(profile.batchPreference)}</p>
                        )}
                    </div>
                )}
            </div>
            ...
            <div className="border rounded-[--radius] p-4 relative space-y-3">
                ...
                <div className="flex items-center gap-2">
                    <Checkbox
                        ...
                        label="Tercih edilen dildeki sürümü zorunlu tut"
                        help="Tercih edilen dilde sürüm bulunamazsa indirmeyi reddet"
                    />
                </div>
                ...
                <div className="flex items-center gap-2">
                    <Checkbox
                        ...
                        label="Tercih edilen kodekteki sürümü zorunlu tut"
                        help="Tercih edilen kodekte sürüm bulunamazsa indirmeyi reddet"
                    />
                </div>
                ...
                <div className="flex items-center gap-2">
                    <Checkbox
                        ...
                        label="Tercih edilen kaynaktaki sürümü zorunlu tut"
                        help="Tercih edilen kaynaktan sürüm bulunamazsa indirmeyi reddet"
                    />
                </div>
            </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                    ...
                    <div className="space-y-2">
                        ...
                        <TextInput
                            ...
                            placeholder="Örn: 2GB ya da 10GiB"
                        />
                    </div>
                </div>
            </div>
    ...
    return (
        <div className="space-y-2">
            ...
            <Combobox
                ...
                multiple
                label="Sağlayıcı Ekle"
                disabled={items.length >= 3}
                emptyMessage="Sağlayıcı bulunamadı"
            />
            {items.length > 0 && (
...
function ReleaseGroupsSortableField() {
    ...
    return (
        <div className="space-y-2">
            <label className="text-sm font-medium">Sürüm Grupları</label>
            <p className="text-sm text-[--muted]">Tercih edilen gruplar öncelik sırasına göre</p>
...
function ResolutionsSortableField() {
    ...
    return (
        <div className="space-y-2">
            <label className="text-sm font-medium">Çözünürlükler</label>
            <p className="text-sm text-[--muted]">Tercih edilen çözünürlükler öncelik sırasına göre</p>
...
function ExcludeTermsSortableField() {
    ...
    return (
        <div className="space-y-2">
            <label className="text-sm font-medium">Hariç Tutulacak Terimler</label>
            <p className="text-sm text-[--muted]">Bu terimleri içeren torrentleri hariç tut</p>
...
function PreferredLanguagesSortableField() {
    ...
    return (
        <div className="space-y-2">
            <label className="text-sm font-medium">Tercih Edilen Diller</label>
            <p className="text-sm text-[--muted]">Tercih edilen diller öncelik sırasına göre</p>
...
function PreferredCodecsSortableField() {
    ...
    return (
        <div className="space-y-2">
            <label className="text-sm font-medium">Tercih Edilen Codecler</label>
            <p className="text-sm text-[--muted]">Tercih edilen codecler öncelik sırasına göre</p>
...
function PreferredSourcesSortableField() {
    ...
    return (
        <div className="space-y-2">
            <label className="text-sm font-medium">Tercih Edilen Kaynaklar</label>
            <p className="text-sm text-[--muted]">Tercih edilen kaynaklar öncelik sırasına göre</p>
...
function PreferenceField(props: {
    ...
    const options = [
        { label: "Tarafsız", value: "neutral" },
        { label: "Tercih Et", value: "prefer" },
        { label: "Kaçın", value: "avoid" },
        { label: "Sadece", value: "only" },
