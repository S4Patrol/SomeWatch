...
export function DiscordRichPresenceSettings(props: DiscordRichPresenceSettingsProps) {
    ...
    return (
        <>
            <SettingsCard title="Rich Presence" description="İzlediğiniz veya okuduğunuz şeyi Discord'da gösterir.">
                <Field.Switch
                    side="right"
                    name="enableRichPresence"
                    label={<span className="flex gap-1 items-center">Aktifleştir</span>}
                />
                <div
                    className={cn(
                ...
                <Field.Switch
                    ...
                    label="SomeWatch Repository Butonunu Gizle"
                />
                ...
                <Field.Switch
                    ...
                    label="AniList Profil Butonunu Göster"
                    help="Profil sayfanızı AniList'te açmak için bir buton gösterir."
                />
