                ...
                <>
                    ...
                    >
                        <TabsList className="flex-wrap max-w-full bg-[--paper] p-2 border rounded-xl">
                            <TabsTrigger value="main">Tema</TabsTrigger>
                        ...
                        <TabsContent value="main" className={tabContentClass}>
                            ...
                            <SettingsCard title="Color scheme">
                                ...
                                {f.watch("enableColorSettings") && (
                                    <>
                                        <Switch
                                            ...
                                            help={enableLivePreview && "Devre dışı bırakmak, değişiklikleri uygulamadan sayfayı yeniden yükler."}
                                ...
                                <Field.Switch
                                    side="right"
                                    label="Bulanıklık efektlerini etkinleştir"
                                    help="Bazı cihazlarda performansı etkileyebilir."
                                    name="enableBlurringEffects"
                                />

                            </SettingsCard>

                            <SettingsCard title="Arka plan resmi">
                                ...
                                <div className="flex flex-col md:flex-row gap-3">
                                    <Field.Text
                                        ...
                                        help="Arka plan resmi. Kütüphane dışı sayfalarda soluk görünür."
                                    />
                            ...
                            <SettingsCard title="Banner resmi">
                                ...
                                <div className="flex flex-col md:flex-row gap-3">
                                    <Field.Text
                                        ...
                                        help="Tüm sayfalar için banner resmi."
                                    />
                                    <Field.Text
                                        label="Konum"
                                        name="libraryScreenCustomBannerPosition"
                                        placeholder="Varsayılan: 50% 50%"
                                    />
                                    <Field.Number
                                        label="Opaklık"
                                ...
                                <AccordionItem value="more">
                                    ...
                                    <AccordionContent className="space-y-4">
                                        ...
                                        <p className="text-[--muted] text-sm">
                                            Özel CSS, sunucuda saklanacak ve her istemciye manuel olarak uygulanması gerekecektir.
                                            <br />
                                            Ayar bozması durumunda, tarayıcı araçlarını kullanarak her zaman yerel depolamadan kaldırabilirsiniz.
                                        </p>
