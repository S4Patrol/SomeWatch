                ...
                <AnimatePresence mode="wait" initial={false}>
                    ...
                    >
                        <div className="space-y-2">
                            <p>
                                Henüz kütüphanenize manga eklenmemiş.
                            </p>
    ...
    return (
        <React.Fragment>
            ...
            <div className="flex gap-3 items-center" data-manga-library-view-collection-list-item-header-container>
                <h2 data-manga-library-view-collection-list-item-header-title>{list.type === "CURRENT" ? "Okumaya devam et" : getMangaCollectionTitle(
                    list.type)}</h2>
                ...
                >
                    <DropdownMenuItem
                        onClick={() => {
                            ...
                            toast.info("Kaynaklardan yeniden çekiliyor...")
                            refetchMangaChapterContainers({
                                selectedProviderMap: storedProviders,
                            })
                        }}
                    >
                        <LuRefreshCcw /> {isRefetchingMangaChapterContainers ? "Yeniden çekiliyor..." : "Kaynakları yenile"}
                    </DropdownMenuItem>
                    <DropdownMenuItem
                        onClick={() => {
                            setParams(draft => {
                    ...
                    >
                        <LuBookOpenCheck /> {params.unreadOnly ? "Hepsini göster" : "Sadece okunmamış bölümler"}
                    </DropdownMenuItem>
                </DropdownMenu>}
