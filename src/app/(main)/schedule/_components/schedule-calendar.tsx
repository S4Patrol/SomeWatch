            ...
            <div className="flex h-full flex-col rounded-xl border" data-schedule-calendar>
                ...
                >
                    ...
                    >
                        ...
                        {isUserSchedule && <>
                            <CheckboxGroup
                                label="Status" options={[
                                            { label: "İzleniyor", value: "CURRENT" },
                              { label: "İzlenecek", value: "PLANNING" },
                        ...
                        <Switch
                            label="İzlenen bölümleri belirt"
                            side="right"
                        ...
                        <Separator />
                        <Switch
                            label="Görsel geçişleri devre dışı bırak"
                            side="right"
    ...
    if (relevantDays.length === 0) {
        return (
            <div className="p-6 text-center text-[--muted]">
                <p>Bu ay için planlanmış bölüm bulunmuyor</p>
            </div>
        )
    }
        ...
        <div className="p-4" data-schedule-calendar-mobile-list-day-item>
            ...
            {day.isToday && day.events.length === 0 && (
                <div className="ml-0 lg:ml-13 text-sm text-[--muted] italic" data-schedule-calendar-mobile-list-day-item-no-events>
                    Bugün için planlanmış bölüm bulunmuyor
                </div>
            )}
        </div>
    )
